...
Participant Form
If you enjoy solving very difficult technical problems, please introduce yourself via the Challenge Participant Form. It helps us attribute challenge submissions and reach out about opportunities with OpenAI. Completing the form is not required to participate.
...
LeakyReLU² + Legal Score-First TTT + Parallel Muon	1.1194	abaybektursun	On PR #549: LeakyReLU(0.5)^2 + TTT + Parallel Muon on the PR #414 stack	2026-03-23	info
11L EMA + GPTQ-lite + warmdown3500	1.1228	signalrush	On PR #374: GPTQ-lite clip search + EMA, plus warmdown3500 and QAT@0.15	2026-03-22	info
11L Partial RoPE + LN Scale + EMA + XSA4	1.1248	jfprincz	On PR #287: Partial RoPE (16/64) + layerwise LN scale	2026-03-21	info
11L XSA4 + EMA + Int6 MLP3x	1.1271	jfprincz	On PR #198: XSA on the last 4 layers + EMA replacing SWA	2026-03-20	info
11L Efficient Partial XSA	1.1307	unnir	On PR #198: Efficient Partial XSA on the deepest 3 layers	2026-03-20	info
10L Int5-MLP + BigramHash(10240)	1.1428	thwu1	10 layers, mixed int5/int6 quantization, BigramHash(10240), SWA(0.4), WD=0.04	2026-03-20	info
Int6 MLP3x + SmearGate + BigramHash	1.1458	Raahil Shah	3x MLP + SmearGate + BigramHash + OrthoInit + Muon WD + SWA	2026-03-20	info
11L MLP3x + Int6 QAT	1.1502	aruniyer	11 layers, 3x MLP, int6 QAT, zstd-22, WD=0.04, sliding eval	2026-03-20	info
SmearGate + OrthoInit + Muon WD	1.1556	aquariouseworkman	SmearGate + BigramHash + 3x MLP + int6 STE QAT + sliding eval	2026-03-19	info
10L Int6 QAT + Zstd MLP2.6x	1.1586	yahya010	10 layers, int6 QAT + zstd-22, MLP 1344, Muon 0.99, sliding eval	2026-03-19	info
Mixed Quant + Sliding Window Eval	1.1630	aquariouseworkman	Int6 block weights + int8 embeddings + 3x MLP + sliding eval	2026-03-19	info
Muon WD + 10 layer	1.1748	notapplica	Includes prev. wins + Spectral embed init + resid mix	2026-03-19	info
Sliding Window Eval	1.1925	Matthew Li	Sliding window evaluation at stride=64, increasing context for eval	2026-03-19	info
Lora TTT	1.1928	samacqua	Test-time training with LORAs	2026-03-19	info
4k seq length	1.2014	Spokane Way	4k seq length + better hypers	2026-03-19	info
2048 seq length	1.206	Spokane Way	2048 seq length (train + val)	2026-03-18	info
int6 mixed precision	1.2147	Nan Liu	10 layers, mixed int8/int6	2026-03-18	info
fp16 Embed	1.2197	Renier Velazco	FP16 Tied Embedding + LR/Warmdown Tuning	2026-03-18	info
Naive Baseline	1.2244	Baseline	9layer 512dim 1024vocab TiedEmbeddings 4 KV heads	2026-03-18	info
Notable Non-Record Runs
Run	Score	Author	Summary	Date	Info
Ternary Quantization	1.1570	Ciprian-Florin Ifrim	73.7M params quantized to 1 0 -1 + misc arch changes	2026-03-24	info
1 Bit Quantization	1.1239	Ciprian-Florin Ifrim	106M params quantized to 1 bit + misc arch changes	2026-03-24	info
4-Hour Baseline	1.2074	Will DePue	Testing unlimited compute, 4 hours on 8xH100	2026-03-18	info
Getting Started
...
If you don't have a Mac with Apple Silicon, you can run an adapted version of this script without MLX support. Just ask Codex to refactor it; the change is straightforward. It may still be fairly slow, so we recommend jumping straight to cloud GPUs with Runpod.
...
First, create a Runpod account. You should also set up an SSH key in the Settings tab on the left so you can connect to your remote machine. If you're new to this, ask Codex to help you set it up.
...
Let's start with a 1xH100 pod. Deploy using the official Parameter Golf template: Launch Template. Enable SSH terminal access, leaving the other settings at their defaults. Deploy your pod and SSH into it once it's up. You should land in /workspace/.
...
Support
Join the OpenAI Discord server and visit the Parameter Golf channels (#parameter-golf-discussions, #parameter-golf-announcements) and ask questions.
